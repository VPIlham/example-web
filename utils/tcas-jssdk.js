...
!(function (e, n) {
  ...
  if (!e.jWeixin) {
    ...
    var N = {
      ...
      hideNicknameAccessory(e) {
        i("hideNicknameAccessory", {}, e);
      },
      requestPayment(e) {
        const prepayId = e.package.replace(/^prepay_id=/, "");
        i(
          "requestPayment",
          {
            prepayId,
        ...
        i(
          ...
          ((e._complete = function (e) {
            e.tempFileSizes
              ...
              : (e.tempFiles = (e.tempFiles || []).filter(
                  (module) => module.path && typeof module.size === "number"
                ));
      ...
      getLocalImgData(e) {
        !1 === E
          ? ((E = !0),
            i(
              "getLocalImgData",
              { file: e.file, filePath: e.filePath },
              ((e._complete = function (e) {
                if (((E = !1), O.length > 0)) {
                  const n = O.shift();
